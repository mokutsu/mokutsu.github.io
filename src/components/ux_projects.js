...
import hdLogo from '../components/hd-logo-en.png';
      ...
      allProjects: [
        {
          ...
          description: 'Taking a data-driven approach to optimize the ux strategy for homedepot.ca, for Appliances, Kitchen, Bath portfolios. Improve browse-based navigation through crisper information architecture.',
          link: '://homedepot.ca'
        },
        {
          name: 'G Adventures',
