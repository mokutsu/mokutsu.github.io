let projectList = [
  {
    ...
    description: 'Built and fixed a django appliacation used by Operations teams using python and JavaScript. Wrote tests, deploy features, refactor legacy code, all that goodness',
  ...
  },
  {
    ...
    description: 'Fix bugs, implement new features for a fully bootstrapped early stage IT marketplace startup using a modern JavaScript toolset and python.',
  ...
  },
  {
    ...
    description: 'Developed a mini weather charting app using react, redux, and open weather API for Stephen Girder\'s react redux course.'
  },
  {
    name: 'Chris T',
    position: 'Full-Stack Developer',
    projectType: 'dev',
    stack: ['react', 'npm', 'css', 'javascript', 'github pages', 'create-react-app'],
  ...
  },
  {
    ...
    position: 'Front-end Developer',
    projectType: 'dev',
    stack: ['javascript', 'three.js', '3d graphics', '3d animations', 'css', 'github pages', 'ruby', 'jekyll'],
  ...
  },
  {
    ...
    description: 'Develop and conduct one-on-one moderated usability testing for Wild Fork Foods',
  ...
  },
  {
    ...
    projectType: 'ux',
    stack: ['ux', 'information architecture', 'site maps', 'user flows', 'wireframes'],
    description: 'Create information architecture for City Exploration app for George Brown College course',
